...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DtRokYWt.mjs");
...
const manifest = {
  "4efd53305823dc2db639567b5dcc33cdcb94a75c0f2464be2ce62e976f8016b7": {
    functionName: "getStudentDetail_createServerFn_handler",
    importer: () => import("./admin-stats.functions-BR7NSZi5.mjs")
  },
  "5200432ce61ed2538961e1da440348eb4c6650f2370fa718d8e8991994daa9ec": {
    functionName: "getLessonPlayback_createServerFn_handler",
    importer: () => import("./bunny.functions-tHeqmyaa.mjs")
  },
  "b015bb2731f1868381610b6fbd12897e996bd035169b632d203eebda96727b7d": {
    functionName: "getStudentsStats_createServerFn_handler",
    importer: () => import("./admin-stats.functions-BR7NSZi5.mjs")
  },
  "b3a80860006869225425b5ff89af690e952f1ccd3f2a97f6d4e93119514822d3": {
    functionName: "deleteBunnyVideo_createServerFn_handler",
    importer: () => import("./bunny.functions-tHeqmyaa.mjs")
  },
  "ec9f329ac6e2e6c860af70d32e72fbfd4ae44cdabbad18e6c8db716354c63001": {
    functionName: "createBunnyVideo_createServerFn_handler",
    importer: () => import("./bunny.functions-tHeqmyaa.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DajYyTeL.mjs").then((n) => n.r),
    import("./start-CjLJCK_f.mjs"),
